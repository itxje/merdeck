...
- Deployment and live evidence (2026-09-12): the hosted instance was relaunched from the main checkout with a build of the sources committed as `b0d4e44`, and the same four checks were repeated against it in a real browser with identical results: the reader's diagram rendered 89 labels at `rgb(17, 17, 17)`, the probe colour rendered at `rgb(192, 0, 0)`, the unreadable pair was corrected to `rgb(250, 250, 250)`, and `color:red` stayed refused, with no page or console errors.
