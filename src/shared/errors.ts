...
const messages: Record<ErrorCode, string> = {
  ...
  directory_changed: 'The directory changed. Restart its listing.',
  cursor_stale: 'The directory cursor is no longer valid. Restart its listing.',
