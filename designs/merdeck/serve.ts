...
const server = Bun.serve({
  ...
  fetch(request) {
    ...
    if (path === '/')
      return new Response('<!doctype html><html lang="en"><title>Design previews</title><a href="/merdeck/Merdeck.html">Merdeck</a></html>', { headers: { 'Content-Type': 'text/html; charset=utf-8' } })
