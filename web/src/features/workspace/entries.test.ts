...
describe('explorer entry actions', () => {
  ...
  it('validates paths before requests and builds requests from actions', () => {
    ...
    expect(entryPathProblem('docs/new.txt', 'file')).toBe('Use a .mmd, .mermaid or .md file name.')
    ...
    expect(entryPathProblem('docs/a.md', 'file', 'docs/a.mmd')).toBe('A rename keeps the file type: Markdown files stay .md.')
